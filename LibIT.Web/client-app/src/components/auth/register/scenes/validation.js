function validateFields(items) {
    ...
    const regex_password = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).{8,24}$/;
    ...
    if (!regex_password.test(password.trim())) errors.password = "Пароль повинен мати мінімум 8 символів, нижній і верхній регістр, та цифри!";
